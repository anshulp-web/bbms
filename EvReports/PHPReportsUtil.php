	...
	******************************************************************************/
	class PHPReportsError{
		function PHPReportsError($sMsg_=null,$sURL_=null){
			...
			print "<span style='font-size:18px;color:#FF0000;font-weight:bold;'>OOOOPS, THERE'S AN MESSAGE HERE.</span><br/><br/>";
			print $sMsg_."<br/><br/>";
	...
	class PHPReportsErrorTr {
		...
		function PHPReportsErrorTr(){
			...
			$this->_aMsgs["OPS"]["default"]				= "OOOOPS !!! ";
			$this->_aMsgs["ERROR"]["default"]			= "";
		...
		function showMsg($sMsg_=null,$oParms_=null)
		{
			...
			if ($sMsg_ == "NODATA" && $GLOBALS["GbRptType"] == 'SUBREPORT' )
			{
				exit();				
			}
